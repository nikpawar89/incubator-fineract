...
@XmlType(name = "requestBody", propOrder = { "vidNsdlRequest", "vidUidaiRequest", "vidVoterRequest" })
public class RequestBody {
	 ...
	 * <CODE>set</CODE> method for the vidNsdlRequest property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the vidUidaiRequest property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the vidVoterRequest property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
