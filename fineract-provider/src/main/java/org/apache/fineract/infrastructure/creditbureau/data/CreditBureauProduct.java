...
public class CreditBureauProduct {
	...
	private CreditBureauProduct(final long credit_bureau_product_id, final String cb_product_name,
	...
	public static CreditBureauProduct instance(final long credit_bureau_product_id, final String cb_product_name,
			final long cb_master_id) {
