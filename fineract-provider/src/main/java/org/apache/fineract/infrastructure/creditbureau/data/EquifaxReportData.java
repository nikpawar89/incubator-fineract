...
public class EquifaxReportData {
	...
	public static EquifaxReportData instance(String score, int numberOfAccounts, BigDecimal totalPastDues,
			BigDecimal totalBalance, int numberOfPastDueAccounts, BigDecimal totalWrittenOfAmount,
			List<AccountTypeData> account) {
		return new EquifaxReportData(score, numberOfAccounts, totalPastDues, totalBalance, numberOfPastDueAccounts,
				totalWrittenOfAmount, account);
	}
