...
public class CreditBureauLpMappingReadPlatformServiceImpl implements CreditBureauLpMappingReadPlatformService {
	...
	@Autowired
	public CreditBureauLpMappingReadPlatformServiceImpl(final PlatformSecurityContext context,
	...
	private static final class CBLPMapper implements RowMapper<CreditBureauLpMappingData> {
		...
		@Override
		public CreditBureauLpMappingData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
				throws SQLException {
	...
	private static final class LpMapper implements RowMapper<CreditBureauLpMappingData> {
		...
		public CreditBureauLpMappingData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)
			...
			return CreditBureauLpMappingData.instance1(loan_product_name, loanid);
		}
	}
	...
	@Override
	public CreditBureauLpMappingData readMappingByLoanId(long loanProductId) {
		this.context.authenticatedUser();
