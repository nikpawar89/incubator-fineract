...
public class CreditBureauLpMapping extends AbstractPersistableCustom<Long> {
	...
	/*
	 * @ManyToOne private CreditBureau cb;
	 * 
	 * @OneToOne private LoanProduct loan_product;
	 * 
	 * 
	 * public static CreditBureauLpMapping fromJson(final JsonCommand command,
	 * CreditBureau creditBureau, LoanProduct loanProduct) { final boolean
	 * is_creditcheck_mandatory=command.booleanPrimitiveValueOfParameterNamed(
	 * "is_creditcheck_mandatory"); final boolean
	 * skip_credit_check_in_failure=command.
	 * booleanPrimitiveValueOfParameterNamed("skip_credit_check_in_failure");
	 * final int
	 * stale_period=command.integerValueOfParameterNamed("stale_period"); final
	 * boolean
	 ...
	 * 
	 * return new
	 * CreditBureauLpMapping(creditBureau,loanProduct,is_creditcheck_mandatory,
	 * skip_credit_check_in_failure,stale_period,is_active);
	 * 
	 * }
	 * 
	 * public CreditBureauLpMapping(CreditBureau cb,LoanProduct
	 * loan_product,boolean is_creditcheck_mandatory, boolean
	 * skip_credit_check_in_failure,int stale_period,boolean is_active ) {
	 * this.cb=cb; this.loan_product=loan_product;
	 * this.is_creditcheck_mandatory=is_creditcheck_mandatory;
	 * this.skip_credit_check_in_failure=skip_credit_check_in_failure;
	 * this.stale_period=stale_period; this.is_active=is_active; }
	 */
	...
	public CreditBureauLpMapping(boolean isCreditCheckMandatory, boolean skipCreditCheckInFailure, int stalePeriod,
			boolean is_active, OrganisationCreditBureau organisation_creditbureau, LoanProduct loan_product) {
	...
	public static CreditBureauLpMapping fromJson(final JsonCommand command,
		...
		final boolean isCreditCheckMandatory = command
				.booleanPrimitiveValueOfParameterNamed("is_creditcheck_mandatory");
		final boolean skipCreditCheckInFailure = command
				.booleanPrimitiveValueOfParameterNamed("skip_creditcheck_in_failure");
