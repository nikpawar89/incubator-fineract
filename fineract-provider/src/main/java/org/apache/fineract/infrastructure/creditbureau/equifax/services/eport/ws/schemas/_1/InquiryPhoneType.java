...
/**
 * 
 * Telephone numbers for Input Inquiry Populate 'Number' for mobile numbers, as
 * mobile numbers do not have STD codes
 * 
 * 
 * <p>
 * Java class for InquiryPhoneType complex type.
 * 
 * <p>
...
@XmlType(name = "InquiryPhoneType", propOrder = { "countryCode", "areaCode", "number", "phoneNumberExtension",
		"phoneType" })
