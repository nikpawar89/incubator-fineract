...
/**
 * <p>
 * Java class for PIIDataType complex type.
 * 
 * <p>
...
@XmlType(name = "PIIDataType", propOrder = { "firstName", "middleName", "lastName", "addresses", "phones", "panCard",
		"passportId", "voterId", "drivingLicense", "nationalIdCard", "rationCard", "otherId", "dob", "gender" })
public class PIIDataType {
	 ...
	 * 
	 * @return possible object is {@link PhonesType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PhonesType }
	 * 
	 */
