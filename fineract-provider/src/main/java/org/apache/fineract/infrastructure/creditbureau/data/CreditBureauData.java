...
public class CreditBureauData {
	...
	private CreditBureauData(final long creditBureauId, final String creditBureauName, final String country,
			final String productName, final String cbSummary, final long implementationkey) {
	...
	public static CreditBureauData instance(final long creditbureau_id, final String creditbureau_name,
			final String country, final String product_name, final String cbSummary, final long implementation_key) {
