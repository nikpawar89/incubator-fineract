...
/**
 * <p>
 * Java class for MaritalStatusOptions.
 * 
 * <p>
...
public enum MaritalStatusOptions {
	...
	@XmlEnumValue("Cohabitating") COHABITATING("Cohabitating"), @XmlEnumValue("Divorced") DIVORCED(
			"Divorced"), @XmlEnumValue("Married") MARRIED("Married"), @XmlEnumValue("Not Asked") NOT_ASKED(
					"Not Asked"), @XmlEnumValue("Not Given") NOT_GIVEN("Not Given"), @XmlEnumValue("Other") OTHER(
							"Other"), @XmlEnumValue("Separated") SEPARATED("Separated"), @XmlEnumValue("Single") SINGLE(
									"Single"), @XmlEnumValue("To Be Married") TO_BE_MARRIED(
											"To Be Married"), @XmlEnumValue("Widowed") WIDOWED("Widowed");
