...
public class CreditBureauLpMappingData {
	...
	private CreditBureauLpMappingData(final long creditbureauLoanProductMappingId,
	...
	public static CreditBureauLpMappingData instance(final long creditbureauLoanProductMappingId,
			final long organisationCreditBureauId, final String alias, final String creditbureauSummary,
			final String loanProductName, final long loanProductId, final boolean isCreditCheckMandatory,
			final boolean skipCrediCheckInFailure, final long stalePeriod, final boolean is_active) {
		return new CreditBureauLpMappingData(creditbureauLoanProductMappingId, organisationCreditBureauId, alias,
	...
	public static CreditBureauLpMappingData instance1(final String loanProductName, final long loanProductId) {
		return new CreditBureauLpMappingData(0, 0, "", "", loanProductName, loanProductId, false, false, 0, false);
	}
