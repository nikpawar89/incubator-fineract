...
public class CreditBureauLpMappingWritePlatformServiceImpl implements CreditBureauLpMappingWritePlatformService {
	...
	@Autowired
	public CreditBureauLpMappingWritePlatformServiceImpl(final PlatformSecurityContext context,
			final CreditBureauLpMappingRepository creditbureauLpMappingRepository,
			final OrganisationCreditBureauRepository orgCbRepository, LoanProductRepository lpRepository,
			final CBLPCommandFromApiJsonDeserializer fromApiJsonDeserializer) {
