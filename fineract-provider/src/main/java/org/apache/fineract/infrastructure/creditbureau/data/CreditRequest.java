...
public class CreditRequest {
	...
	public CreditRequest(final String FirstName, final String LastName, final String gender, final String ExternalId1,
			final String ExternalId2, final LocalDate dateOfBirth, final String phonenumber, final String address,
			final String occupation, final double monthlySalary, final double annualSalary, final String enquiryReason,
			final String loanid, final String clientId, final String groupId) {
