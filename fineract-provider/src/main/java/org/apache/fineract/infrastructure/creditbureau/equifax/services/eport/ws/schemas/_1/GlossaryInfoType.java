...
/**
 * <p>
 * Java class for GlossaryInfoType complex type.
 * 
 * <p>
...
@XmlType(name = "GlossaryInfoType", propOrder = { "accountStatus", "paymentHistoryStatus", "assetClassificationStatus",
		"suitFiledStatus" })
public class GlossaryInfoType {
	 ...
	 * <CODE>set</CODE> method for the accountStatus property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the paymentHistoryStatus property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the assetClassificationStatus property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the suitFiledStatus property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
