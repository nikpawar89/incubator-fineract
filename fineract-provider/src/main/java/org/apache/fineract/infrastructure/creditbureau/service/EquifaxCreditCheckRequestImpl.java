...
public class EquifaxCreditCheckRequestImpl implements EquifaxCreditCheckRequest
{
   ...
   public  EquifaxReportData processRequest() 
    ...
    private static EquifaxReportData printResponse(InquiryResponseType responseType)
            ...
            JAXBContext jc = JAXBContext.newInstance(org.apache.fineract.infrastructure.creditbureau.equifax.services.eport.ws.schemas._1.InquiryResponseType.class);
    ...
    private static void printRequest(InquiryRequestType requestType)throws JAXBException
    {
            ...
            JAXBContext jc = JAXBContext.newInstance(org.apache.fineract.infrastructure.creditbureau.equifax.services.eport.ws.schemas._1.InquiryRequestType.class);    
