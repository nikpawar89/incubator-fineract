...
/**
 * <p>
 * Java class for responseBody complex type.
 * 
 * <p>
...
@XmlType(name = "responseBody", propOrder = { "vidNsdlResponses", "vidUidaiResponses", "vidVoterResponses" })
public class ResponseBody {
	 ...
	 * <CODE>set</CODE> method for the vidNsdlResponses property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the vidUidaiResponses property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the vidVoterResponses property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
