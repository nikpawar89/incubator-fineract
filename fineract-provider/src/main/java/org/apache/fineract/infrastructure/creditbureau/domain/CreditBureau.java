...
public class CreditBureau extends AbstractPersistableCustom<Long> {
	 ...
	 * CreditBureauMaster creditBureauMaster, CreditBureauProduct
	 * creditBureauProduct) { String edate=null; final String alias =
	 * command.stringValueOfParameterNamed("alias"); final String country =
	 * command.stringValueOfParameterNamed("country"); LocalDate start_date =
	 * command.localDateValueOfParameterNamed("start_date"); LocalDate end_date
	 * = command.localDateValueOfParameterNamed("end_date"); String
	 * sdate=start_date.toString();
	 * 
	 * if(edate!=null) edate=end_date.toString();
	 * 
	 * final boolean is_active =
	 * command.booleanPrimitiveValueOfParameterNamed("is_active"); return new
	 * CreditBureau(creditBureauMaster, creditBureauProduct, alias, country,
	 * sdate, edate, is_active);
	 * 
	 * }
	 */

	/*
	 * @ManyToOne private CreditBureauMaster cb_master;
	 * 
	 * @OneToOne private CreditBureauProduct cb_product;
	 * 
	 * @OneToMany(mappedBy="cb", cascade=CascadeType.ALL) private
	 * List<CreditBureauLpMapping> CreditBureauLpMapping=new ArrayList<>();
	 */

	/*
	 * public CreditBureau(CreditBureauMaster creditBureauMaster,
	 * CreditBureauProduct creditBureauProduct, String alias, String country,
	 * String start_date, String end_date, boolean is_active) { this.cb_master =
	 * creditBureauMaster; this.cb_product = creditBureauProduct; this.country =
	 * country;
	 * 
	 * 
	 * 
