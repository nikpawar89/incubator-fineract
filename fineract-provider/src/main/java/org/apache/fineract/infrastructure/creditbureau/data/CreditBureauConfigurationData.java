...
public class CreditBureauConfigurationData {
	...
	private CreditBureauConfigurationData(final long creditbureauConfigurationId, final String configkey,
			final String value, final long organisationCreditbureauId, final String description) {
	...
	public static CreditBureauConfigurationData instance(final long creditbureauConfigurationId, final String configkey,
			final String value, final long organisationCreditbureauId, final String description) {
